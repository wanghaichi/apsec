...
class Page {
    ...
    protected $coolPages   ;
    // 分页显示定制
    protected $config  =	array('header'=>'records ','prev'=>'former page','next'=>'next page','first'=>'first page','last'=>'last page','theme'=>' %totalRow% %header% %nowPage%/%totalPage% page %upPage% %downPage% %first%  %prePage%  %linkPage%  %nextPage% %end%');

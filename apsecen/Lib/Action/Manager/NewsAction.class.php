...
class NewsAction extends Action {
    ...
    function columnsList(){
        ...
        $result["total"] = $Msg->field('apecen_columns.id,apecen_colname.name as cid,apecen_columns.name,content,sequence')
                               ->join('apecen_colname on apecen_colname.id=apecen_columns.cid')
                               ->where($data)->count();

        $result["rows"] = $Msg->field('apecen_columns.id,apecen_colname.name as cid,apecen_columns.name,content,sequence')
                              ->join('apecen_colname on apecen_colname.id=apecen_columns.cid')
